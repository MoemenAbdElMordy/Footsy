...
<div class="container-fluid px-3 px-md-4 d-flex align-items-center justify-content-center" style="min-height: calc(100vh - 200px); padding-top: var(--spacing-xl); padding-bottom: var(--spacing-xl);">
    <div class="card w-100" style="max-width: 28rem;">
        ...
        <div class="card-body p-3 p-md-4">
            <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST" class="d-flex flex-column gap-3">
                <?php echo csrf_field(); ?>
                <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\self practise\footsy\Footwear E-Commerce Website PRD\resources\views/pages/admin/login.blade.php ENDPATH**/ ?>