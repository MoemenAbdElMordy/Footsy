                                ...
                                <select id="savedAddress" class="form-select" style="background-color: var(--color-input-background);">
                                    ...
                                    <?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($addr->id); ?>"
                                            data-full-name="<?php echo e($addr->full_name); ?>"
                                            data-address="<?php echo e($addr->address); ?>"
                                            data-city="<?php echo e($addr->city); ?>"
                                            data-state="<?php echo e($addr->state); ?>"
                                            data-zip-code="<?php echo e($addr->zip_code); ?>"
                                            data-phone="<?php echo e($addr->phone); ?>"
                                            <?php echo e((!empty($defaultAddress) && $defaultAddress->id === $addr->id) ? 'selected' : ''); ?>>
                                            <?php echo e($addr->label ?: 'Address'); ?> - <?php echo e($addr->city); ?>, <?php echo e($addr->state); ?>

                                            <?php echo e($addr->is_default ? '(Default)' : ''); ?>
...
<script>
    ...
    const stripeKey = <?php echo json_encode(config('stripe.key'), 15, 512) ?>;
    ...
    checkoutForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const paymentIntentRes = await fetchWithTimeout(<?php echo json_encode(route('checkout.payment_intent'), 15, 512) ?>, {
                method: 'POST',
                headers: {
            ...
            const confirmRes = await fetchWithTimeout(<?php echo json_encode(route('checkout.confirm'), 15, 512) ?>, {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\self practise\footsy\Footwear E-Commerce Website PRD\resources\views/pages/checkout/index.blade.php ENDPATH**/ ?>